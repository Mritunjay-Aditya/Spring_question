...
public class TrackController {
    ...
    public ResponseEntity<Track> createTrack(@RequestBody TrackRequest trackRequest){
        return new ResponseEntity<Track>(trackService.createTrack(trackRequest),HttpStatus.CREATED);
    }
    /**
     * Get all tracks
     * @return
    ...
    public ResponseEntity<List<Track>> getTracksSorted() {
        return new ResponseEntity<List<Track>>(trackService.sortedTracks(),HttpStatus.OK);
    }
}
